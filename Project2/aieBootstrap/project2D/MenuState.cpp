...
void MenuState::onDraw(Renderer2D* renderer2D)
{
	...
	renderer2D->drawSprite(m_Ice, 580.0f, 360.0f, m_Ice->getWidth(), m_Ice->getHeight(), 0, 50.0f, 0.0f, 0.0f);
	renderer2D->drawSprite(m_Glider, 580.0f, 280.0f, m_Glider->getWidth(), m_Glider->getHeight(), 0, 50.0f, 0.0f, 0.0f);
	renderer2D->drawText(m_font, instructions, 580.0f, 100.0f);
